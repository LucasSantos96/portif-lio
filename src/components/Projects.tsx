...
const Projects: React.FC = () => {
  ...
  return (
    <section
      className="my-20 mx-4 text-white mb-14 flex flex-col items-center lg:mx-32 lg:py-28"
      id="projetos"
    >
      <div>
        <h2 className="text-[20px] mb-5 lg:text-[40px] lg:text-center">
          Projetos
        </h2>
      </div>
      ...
      <div className="w-full flex items-center justify-center  gap-10 flex-wrap   ">
        <CardProjects
          link={"https://mei-landing.vercel.app/"}
          image={"/diario-contabil.png"}
          title="Diário Contábil"
          subtitle="Sistema inteligente de gestão de assinaturas MEI integrado ao Mercado Pago, desenvolvido com Next.js, TypeScript e Tailwind CSS. A plataforma utiliza webhooks estrategicamente para orquestrar o ciclo completo de pagamentos recorrentes, realizando validações instantâneas de CPF/CNPJ e disparando notificações automatizadas via SMTP para assegurar a conformidade fiscal do microempreendedor. Inclui checkout transparente de alta conversão, processamento modular de dados, segurança em fluxos de API e integração fullstack completa, focada na simplificação burocrática e automação de serviços contábeis."
          tecImg={[
            <SiNextdotjs key="mei1" size={iconSize} color="#000000" />,
            <SiTailwindcss key="mei2" size={iconSize} color="#06B6D4" />,
            <SiTypescript key="mei3" size={iconSize} color="#3178C6" />,
            <SiNodedotjs key="mei4" size={iconSize} color="#339933" />,
            <SiGit key="mei5" size={iconSize} color="#F05032" />,
          ]}
        />

        <CardProjects
          link={"https://github.com/LucasSantos96/api_barber"}
        ...
        <CardProjects
          link={"https://saas-study-21vg.vercel.app/"}
          image={"/eduai.png"}
          title="Edu ai"
        ...
        <CardProjects
          link={"https://lp-stefani.vercel.app/"}
          image={"/stefani.png"}
        ...
        <CardProjects
          link={"https://blognode-mntu.onrender.com/"}
          image={"/blognode.png"}
          title="BlogNode"
        ...
        <CardProjects
          link={"https://lucassantos96.github.io/boa-forma/"}
          image={"/boaForma.png"}
          title="Boa forma"
        ...
        <CardProjects
          link={"https://lucassantos96.github.io/linksseubeca/"}
          image={"/seuBeca.png"}
